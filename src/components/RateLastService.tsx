...
const RateLastService: React.FC<RateLastServiceProps> = ({
  onComplete,
  onSkip,
  onRebook
}) => {
      ...
      <Card className="max-w-md mx-auto animate-scale-in">
        <CardContent className="pt-8 text-center">
          ...
          <div className="space-y-2">
            <Button onClick={onRebook} variant="default" className="w-full">
    ...
    <div className="max-w-lg mx-auto space-y-6 animate-fade-in">
      ...
      <div className="space-y-2">
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <Button onClick={onRebook} variant="outline" size="sm">
            <Repeat className="h-4 w-4 mr-2" />
            Rebook Service
          </Button>
        </div>
